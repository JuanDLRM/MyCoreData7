...
class ViewController: UIViewController {
    ...
    @IBAction func btnSave(_ sender: AnyObject) {
        ...
        if (contactdb != nil)
        {
            ...
            contactdb.setValue(amount.text, forKey: "amount")
            contactdb.setValue(usd.text, forKey: "usd")
            contactdb.setValue(date.text, forKey: "date")
        }
        else
        {
            ...
            contact.amount = amount.text!
            contact.usd = usd.text!
            contact.date = date.text!
        }
        var error: NSError?
        do {
...
//        present(detailVC, animated: false)
    ...
    override func viewDidLoad() {
        ...
        if (contactdb != nil)
        {
            ...
            amount.text = contactdb.value(forKey: "amount") as? String
            usd.text = contactdb.value(forKey: "phone") as? String
            date.text = contactdb.value(forKey: "date") as? String
